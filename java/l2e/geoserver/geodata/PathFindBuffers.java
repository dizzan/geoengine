...
public class PathFindBuffers {
	...
	public static class GeoNode {
		...
		public static GeoNode initNode(PathFindBuffer buff, int bx, int by, int x, int y, short z, double mCost,
				GeoNode parentNode) {
			GeoNode result;
			if (buff == null) {
				result = new GeoNode();
		...
		public String toString() {
			return (new StringBuilder()).append("GeoNode: ").append(_x).append("\t").append(_y).append("\t").append(_z)
					.toString();
		}
